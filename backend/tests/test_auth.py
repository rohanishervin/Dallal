...
async def test_login_invalid_credentials():
    ...
    login_data = {"username": "invalid_user", "password": "invalid_password", "device_id": "test_device"}
...
async def test_login_missing_username():
    ...
    login_data = {"password": "some_password", "device_id": "test_device"}
...
async def test_login_missing_password():
    ...
    login_data = {"username": "some_user", "device_id": "test_device"}
